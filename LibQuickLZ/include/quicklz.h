...
QLZ_API size_t qlz_size_decompressed(const char *source);
QLZ_API size_t qlz_size_compressed(const char *source);
QLZ_API size_t qlz_compress(const void *source, char *destination, size_t size, qlz_state_compress *state);
QLZ_API size_t qlz_decompress(const char *source, void *destination, qlz_state_decompress *state);
QLZ_API int qlz_get_setting(int setting);
