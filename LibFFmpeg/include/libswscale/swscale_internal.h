...
#define LOCAL_ALIGN(n) __declspec(align(8))
extern LOCAL_ALIGN(8) const uint8_t ff_dither_2x2_4[3][8];
extern LOCAL_ALIGN(8) const uint8_t ff_dither_2x2_8[3][8];
extern LOCAL_ALIGN(8) const uint8_t ff_dither_4x4_16[5][8];
extern LOCAL_ALIGN(8) const uint8_t ff_dither_8x8_32[9][8];
extern LOCAL_ALIGN(8) const uint8_t ff_dither_8x8_73[9][8];
extern LOCAL_ALIGN(8) const uint8_t ff_dither_8x8_128[9][8];
extern LOCAL_ALIGN(8)  const uint8_t ff_dither_8x8_220[9][8];
