...
*
*--*/
freelecTwitCurl::freelecTwitCurl() :
m_curlHandle( NULL ),
...
*
*--*/
freelecTwitCurl* freelecTwitCurl::clone()
{
    freelecTwitCurl *cloneObj = new freelecTwitCurl();
...
*
*--*/
bool freelecTwitCurl::isCurlInit()
{
...
*
*--*/
std::string& freelecTwitCurl::getTwitterUsername()
{
...
*
*--*/
std::string& freelecTwitCurl::getTwitterPassword()
{
...
*
*--*/
void freelecTwitCurl::setTwitterUsername(std::string& userName)
{
    if( userName.length() )
    {
...
*
*--*/
void freelecTwitCurl::setTwitterPassword(std::string& passWord)
{
    if( passWord.length() )
    {
...
void freelecTwitCurl::setTwitterUsername(const char * userName /* in */)
{
    if (userName != NULL)
    {
        m_twitterUsername = userName;
...
void freelecTwitCurl::setTwitterPassword(const char * passWord /* in */)
{
    if (passWord != NULL)
    {
        m_twitterPassword = passWord;
...
*
*--*/
std::string& freelecTwitCurl::getProxyServerIp()
{
...
*
*--*/
std::string& freelecTwitCurl::getProxyServerPort()
{
...
*
*--*/
std::string& freelecTwitCurl::getProxyUserName()
{
...
*
*--*/
std::string& freelecTwitCurl::getProxyPassword()
{
...
*
*--*/
void freelecTwitCurl::setProxyServerIp(std::string& proxyServerIp)
{
...
*
*--*/
void freelecTwitCurl::setProxyServerPort(std::string& proxyServerPort)
{
...
*
*--*/
void freelecTwitCurl::setProxyUserName(std::string& proxyUserName)
{
...
*
*--*/
void freelecTwitCurl::setProxyPassword(std::string& proxyPassword)
{
...
*
*--*/
bool freelecTwitCurl::search(std::string& searchQuery, std::string resultCount)
{
    /* Prepare URL */
...
*
*--*/
bool freelecTwitCurl::statusUpdate(std::string& newStatus, std::string inReplyToStatusId)
{
    if( newStatus.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::statusShowById(std::string& statusId)
{
    if( statusId.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::statusDestroyById(std::string& statusId)
{
    if( statusId.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::retweetById(std::string& statusId)
{
    if( statusId.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::timelineHomeGet(std::string sinceId)
{
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::timelinePublicGet()
{
    /* Perform GET */
...
*
*--*/
bool freelecTwitCurl::featuredUsersGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::timelineFriendsGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::mentionsGet(std::string sinceId)
{
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::timelineUserGet(bool trimUser, bool includeRetweets, unsigned int tweetCount,
...
*
*--*/
bool freelecTwitCurl::userLookup(std::vector<std::string> &userInfo, bool isUserId)
{
    if( userInfo.empty() )
    {
        return false;
...
bool freelecTwitCurl::userLookup(std::string userIn /* in */, bool isUserId  /* in */)
{
    
    std::vector<std::string> userInfo;

    // 사용자 아이디 string vector 만들어 주기
    int pos = 0;
    std::string token;
    std::string deliminator = ",";
    while ((pos = userIn.find(deliminator)) != std::string::npos) {
        token = userIn.substr(0, pos);
        userInfo.push_back(token);
        userIn.erase(0, pos + deliminator.length());
    }
    userInfo.push_back(userIn);
...
*
*--*/
bool freelecTwitCurl::userGet(std::string& userInfo, bool isUserId)
{
    if( userInfo.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::friendsGet(std::string userInfo, bool isUserId)
{
    /* Set URL */
    std::string buildUrl;
    utilMakeUrlForUser( buildUrl, twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::followersGet(std::string userInfo, bool isUserId)
{
    /* Prepare URL */
    std::string buildUrl;
    utilMakeUrlForUser( buildUrl, twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::directMessageGet(std::string sinceId)
{
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::directMessageSend(std::string& userInfo, std::string& dMsg, bool isUserId)
{
...
*
*--*/
bool freelecTwitCurl::directMessageGetSent()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::directMessageDestroyById(std::string& dMsgId)
{
    if( dMsgId.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::friendshipCreate(std::string& userInfo, bool isUserId)
{
    if( userInfo.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::friendshipDestroy(std::string& userInfo, bool isUserId)
{
    if( userInfo.empty() )
    {
        return false;
...
*
*--*/
bool freelecTwitCurl::friendshipShow(std::string& userInfo, bool isUserId)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::friendsIdsGet(std::string& nextCursor, std::string& userInfo, bool isUserId)
{
    /* Prepare URL */
    std::string buildUrl;
    utilMakeUrlForUser( buildUrl, twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
bool freelecTwitCurl::friendsIdsGet(const char *nextCursor/* in */, const char* userInfo /* in */, bool isUserId  /* in */)
{
    /* Prepare URL */
    std::string nextCursorString = nextCursor;
    std::string userInfoString = userInfo;
    std::string buildUrl;
    utilMakeUrlForUser(buildUrl, twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
        twitterDefaults::TWITCURL_FRIENDSIDS_URL +
        twitCurlDefaults::TWITCURL_EXTENSIONFORMATS[m_eApiFormatType],
        userInfoString, isUserId);

    if (buildUrl.length() && nextCursorString.length())
    {
        buildUrl += twitCurlDefaults::TWITCURL_URL_SEP_AMP +
            twitCurlDefaults::TWITCURL_NEXT_CURSOR +
            nextCursorString;
...
*
*--*/
bool freelecTwitCurl::followersIdsGet(std::string& nextCursor, std::string& userInfo, bool isUserId)
{
    /* Prepare URL */
    std::string buildUrl;
    utilMakeUrlForUser( buildUrl, twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::accountRateLimitGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::accountVerifyCredGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::favoriteGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::favoriteCreate(std::string& statusId)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::favoriteDestroy(std::string& statusId)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::blockCreate(std::string& userInfo)
{
        /* Prepare URL */
        std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::blockDestroy(std::string& userInfo)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::blockListGet(std::string& nextCursor, bool includeEntities, bool skipStatus)
{
    /* Prepare URL */
...
*
*--*/
bool freelecTwitCurl::blockIdsGet(std::string& nextCursor, bool stringifyIds)
{
    /* Prepare URL */
    std::string buildUrl, urlParams;
...
*
*--*/
bool freelecTwitCurl::savedSearchGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::savedSearchShow(std::string& searchId)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::savedSearchCreate(std::string& query)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::savedSearchDestroy(std::string& searchId)
{
    /* Prepare URL */
    std::string buildUrl = twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::trendsGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::trendsDailyGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::trendsWeeklyGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::trendsCurrentGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
bool freelecTwitCurl::trendsAvailableGet()
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
...
*
*--*/
void freelecTwitCurl::getLastWebResponse(std::string& outWebResp)
{
    outWebResp = "";
...
*
*--*/
void freelecTwitCurl::getLastCurlError(std::string& outErrResp)
{
...
*
*--*/
int freelecTwitCurl::curlCallback(char* data, size_t size, size_t nmemb, freelecTwitCurl* pTwitCurlObj)
{
...
*
*--*/
int freelecTwitCurl::saveLastWebResponse(char*& data, size_t size)
{
    if( data && size )
    {
...
*
*--*/
void freelecTwitCurl::clearCurlCallbackBuffers()
{
    m_callbackData = "";
...
*
*--*/
void freelecTwitCurl::prepareCurlProxy()
{
...
*
*--*/
void freelecTwitCurl::prepareCurlCallback()
{
...
*
*--*/
void freelecTwitCurl::prepareCurlUserPass()
{
...
*
*--*/
void freelecTwitCurl::prepareStandardParams()
{
...
*
*--*/
bool freelecTwitCurl::performGet(const std::string& getUrl)
{
	...
	CURLcode code;
	code = curl_easy_setopt(m_curlHandle, CURLOPT_HTTPGET, 1);
	code = curl_easy_setopt(m_curlHandle, CURLOPT_URL, getUrl.c_str());

    /* Send http request */
	code = curl_easy_perform(m_curlHandle);
    if( CURLE_OK == code)
    {
        if( pOAuthHeaderList )
        {
...
*
*--*/
bool freelecTwitCurl::performGetInternal(const std::string& getUrl,
...
*
*--*/
bool freelecTwitCurl::performDelete(const std::string& deleteUrl)
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
...
*
*--*/
bool freelecTwitCurl::performPost(const std::string& postUrl, std::string dataStr)
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
...
*
*--*/
oAuth& freelecTwitCurl::getOAuth()
{
    return m_oAuth;
}
...
*
*--*/
bool freelecTwitCurl::oAuthRequestToken(std::string& authorizeUrl /* out */)
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
...
*
*--*/
bool freelecTwitCurl::oAuthAccessToken()
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
...
*
*--*/
bool freelecTwitCurl::oAuthHandlePIN(const std::string& authorizeUrl /* in */)
{
    /* Return if cURL is not initialized */
    if( !isCurlInit() )
    {
...
bool freelecTwitCurl::performAuth()
{
    ...
    //getOAuth().setConsumerKey(std::string("LJ4uJuOE4hEYG3OiCrftQ"));
    //getOAuth().setConsumerSecret(std::string("vlYbnhUwLp0pEt8fISQyqet5Iw5wu5kW4RWOtERx8"));
    ...
    if (myOAuthAccessTokenKey.size() && myOAuthAccessTokenSecret.size())
    {
        ...
        getOAuth().setOAuthTokenKey(myOAuthAccessTokenKey);
        getOAuth().setOAuthTokenSecret(myOAuthAccessTokenSecret);
    }
    else
    {
        /* Step 2: Get request token key and secret */
        std::string authUrl;
        oAuthRequestToken(authUrl);
    ...
    if (accountVerifyCredGet())
    {
        getLastWebResponse(replyMsg);
        return true;
    }
    else
    {
        getLastCurlError(replyMsg);
        return false;
    }
}

bool freelecTwitCurl::getLastWebResponseParse()
{
	try {
		m_document.Clear();
	}
    ...
    if (m_document.Parse<2>(m_callbackData.c_str()).HasParseError())
        return false;

    return true;
}

std::string freelecTwitCurl::friendsIdsParse(std::string objectname)
{
    getLastWebResponseParse();
    std::string result;

    if (objectname.compare("ids") == 0)
    {
        
        const rapidjson::Value& a = m_document["ids"];
        for (rapidjson::SizeType i = 0; i < a.Size(); i++) // rapidjson uses SizeType instead of size_t.
        {
            std::stringstream ss;
            ss << a[i].GetInt();

            std::string resultnum(ss.str());
...
std::string freelecTwitCurl::userLookupParse(std::string objectname)
{
    getLastWebResponseParse();
    std::string result;

    if (objectname.compare("name") == 0)
    {
        int size = m_document.Size();
        for (int i = 0; i < size; i++)
        {
            std::string aname = m_document[rapidjson::SizeType(i)]["name"].GetString();
            result = result + aname + ",";
        }
        result = result.substr(0, result.size() - 1);
        return result;
