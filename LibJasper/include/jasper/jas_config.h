...
#if defined(JASPER__NO_DLL)
#define JASPER_API

#elif defined(_MSC_VER)
#ifdef JASPER_API_EXPORTS
#define	JASPER_API __declspec(dllexport)
#else
#define JASPER_API __declspec(dllimport)
#endif

#elif defined(JASPER__USE_VISIBILITY_ATTR)
#define JASPER_API __attribute__ ((visibility ("default")))
