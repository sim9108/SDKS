...
template class DllDef std::basic_string<char, std::char_traits<char>, std::allocator<char> >;
template class DllDef std::basic_string<wchar_t, std::char_traits<wchar_t>, std::allocator<wchar_t> >;
#endif
