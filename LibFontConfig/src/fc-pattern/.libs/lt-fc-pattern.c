...
/* ./.libs/lt-fc-pattern.c - temporary wrapper executable for .libs/fc-pattern
   Generated by libtool (GNU libtool) 2.4.2

   The fc-pattern program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "fc-pattern"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fc-pattern - temporary wrapper script for .libs/fc-pattern\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The fc-pattern program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libfontconfig.la /usr/lib/libfreetype.la /usr/lib/li", f);
  fputs ("bpng16.la /usr/lib/libpng16.la /usr/lib/libexpat.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"fc-pattern:fc-pattern:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fc-pattern:fc-pattern:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fc-pattern:fc-pattern:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
