...
/* ./.libs/lt-fc-validate.c - temporary wrapper executable for .libs/fc-validate
   Generated by libtool (GNU libtool) 2.4.2

   The fc-validate program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/home/fontconfig-2.11.1/src/.libs:/usr/lib:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/fontconfig-2.11.1/src/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "fc-validate"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# fc-validate - temporary wrapper script for .libs/fc-validate\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The fc-validate program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../src/libfontconfig.la /usr/lib/libexpat.la /usr/lib/libfr", f);
  fputs ("eetype.la /usr/lib/libpng16.la /usr/lib/libpng16.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"fc-validate:fc-validate:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"fc-validate:fc-validate:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"fc-validate:fc-validate:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/home/fontconfig-2.11.1/src/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/fontconfig-2.11.1/src/.libs:/usr/lib:$PATH\"\n", f);
  fputs ("\n", f);
