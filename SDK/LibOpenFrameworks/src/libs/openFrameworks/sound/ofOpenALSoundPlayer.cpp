...
// ----------------------------------------------------------------------------
bool ofOpenALSoundPlayer::sfReadFile(const used_filesystem::path& path, vector<short> & buffer, vector<float> & fftAuxBuffer){
	SF_INFO sfInfo;
...
#ifdef OF_USING_MPG123
//------------------------------------------------------------
bool ofOpenALSoundPlayer::mpg123ReadFile(const used_filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	int err = MPG123_OK;
...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::sfStream(const used_filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	if(!streamf){
		SF_INFO sfInfo;
...
#ifdef OF_USING_MPG123
//------------------------------------------------------------
bool ofOpenALSoundPlayer::mpg123Stream(const used_filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	if(!mp3streamf){
		int err = MPG123_OK;
...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::stream(const used_filesystem::path& fileName, vector<short> & buffer){
#ifdef OF_USING_MPG123
...
bool ofOpenALSoundPlayer::readFile(const used_filesystem::path& fileName, vector<short> & buffer){
#ifdef OF_USING_MPG123
...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::load(const used_filesystem::path& _fileName, bool is_stream){

	used_filesystem::path fileName = ofToDataPath(_fileName);
