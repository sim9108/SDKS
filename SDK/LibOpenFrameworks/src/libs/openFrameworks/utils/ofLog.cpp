...
//--------------------------------------------------
void ofLogToFile(const used_filesystem::path & path, bool append){
...
ofFileLoggerChannel::ofFileLoggerChannel(const used_filesystem::path & path, bool append){
	setFile(path,append);
}
...
void ofFileLoggerChannel::setFile(const used_filesystem::path & path,bool append){
