...
/// \todo Needs documentation.
bool ofLoadImage(ofPixels & pix, const used_filesystem::path& path, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofPixels & pix, const ofBuffer & buffer, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofFloatPixels & pix, const used_filesystem::path& path, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofFloatPixels & pix, const ofBuffer & buffer, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofShortPixels & pix, const used_filesystem::path& path, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofShortPixels & pix, const ofBuffer & buffer, const ofImageLoadSettings &settings = ofImageLoadSettings());

/// \todo Needs documentation.
bool ofLoadImage(ofTexture & tex, const used_filesystem::path& path, const ofImageLoadSettings &settings = ofImageLoadSettings());
bool ofLoadImage(ofTexture & tex, const ofBuffer & buffer, const ofImageLoadSettings &settings = ofImageLoadSettings());

/// \todo Needs documentation.
bool ofSaveImage(const ofPixels & pix, const used_filesystem::path& path, ofImageQualityType qualityLevel = OF_IMAGE_QUALITY_BEST);
...
/// \todo Needs documentation.
bool ofSaveImage(const ofFloatPixels & pix, const used_filesystem::path& path, ofImageQualityType qualityLevel = OF_IMAGE_QUALITY_BEST);
...
/// \todo Needs documentation.
bool ofSaveImage(const ofShortPixels & pix, const used_filesystem::path& path, ofImageQualityType qualityLevel = OF_IMAGE_QUALITY_BEST);
...
public:
	...
	ofImage_(const used_filesystem::path & fileName, const ofImageLoadSettings &settings = ofImageLoadSettings());
	...
	bool load(const used_filesystem::path& fileName, const ofImageLoadSettings &settings = ofImageLoadSettings());
	...
	bool save(const used_filesystem::path & fileName, ofImageQualityType compressionLevel = OF_IMAGE_QUALITY_BEST) const;
