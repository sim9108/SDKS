...
//-----------------------------------------------------------
static bool loadFontFace(const used_filesystem::path& _fontname, FT_Face & face, used_filesystem::path & filename){
	used_filesystem::path fontname = _fontname;
...
//-----------------------------------------------------------
bool ofTrueTypeFont::load(const used_filesystem::path& filename, int fontSize, bool antialiased, bool fullCharacterSet, bool makeContours, float simplifyAmt, int dpi) {
