...
unless (caller) {
    ...
    use lib 'D:/near/engin/openframeworks/SDK/LibOpenSSL/src/util/perl';
    use OpenSSL::fallback 'D:/near/engin/openframeworks/SDK/LibOpenSSL/src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'D:/near/engin/openframeworks/SDK/LibOpenSSL/src/Configurations';
        use gentemplate;
