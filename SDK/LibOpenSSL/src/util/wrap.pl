...
BEGIN {
    ...
    require 'D:/near/engin/openframeworks/SDK/LibOpenSSL/src/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/near/engin/openframeworks/SDK/LibOpenSSL/src/test/fips-and-base.cnf';
    shift;
