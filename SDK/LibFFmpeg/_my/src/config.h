...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86 --enable-pic --enable-gpl --enable-version3 --enable-nonfree --cpu=i686 --enable-libaom --enable-static --enable-libx264 --enable-libx265 --enable-libfdk-aac --enable-libdav1d"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "./DATA"
#define AVCONV_DATADIR "./DATA"
